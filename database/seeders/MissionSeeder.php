...
class MissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $exemplos = [
            // [titulo, data, hora, responsavel, prioridade, situacao, demandante, obs, concluida_por]
            ...
            ['Inspeção das instalações', $iso($hoje->copy()->addDays(2)), '08:00', 'Sd EP Ferreira Lima', 'alta', 'pendente', 'Comando', 'Verificar pendências antes da inspeção.', null],
            ['Fechamento do relatório semanal', $iso($hoje->copy()->addDays(3)), '15:30', '3º Sgt Rodrigues Silva', 'media', 'pendente', 'Adjunto', 'Consolidar missões concluídas e pendentes.', null],
